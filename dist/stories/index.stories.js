...
class YoutubeEmbed extends react_1.default.Component {
    render() {
        const { attrs } = this.props;
        const videoId = attrs.matches[1];
        return (react_1.default.createElement("iframe", { className: this.props.isSelected ? "ProseMirror-selectednode" : "", src: `https://www.youtube.com/embed/${videoId}?modestbranding=1` }));
    }
}
const embeds = [
    {
    ...
    },
    {
        title: "Spotify",
        keywords: "spotify",
        icon: () => (react_1.default.createElement("img", { src: "https://cdn.cdnlogo.com/logos/s/52/spotify.svg", height: 24 })),
        matcher: (url) => {
            return !!url.match(/(?:https?:\/\/)?(?:www\.)?youtu\.?be(?:\.com)?\/?.*(?:watch|embed)?(?:.*v=|v\/|\/)([a-zA-Z0-9_-]{11})$/i);
        },
        component: YoutubeEmbed,
